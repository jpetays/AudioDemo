...
namespace Prg.Ui.PageCarousel
{
    ...
    public class PageSlider : MonoBehaviour
    {
        ...
        public Rect Rect
        {
            get { return ((RectTransform)transform).rect; }
        }

        private PageScroller _scroller;
        private bool _hasDotsIndicator;
        ...
        private void Awake()
        {
            ...
            _hasDotsIndicator = _dotsIndicator != null;
        }
        ...
        public void AddPage(RectTransform content)
        {
            ...
            var page = new GameObject(string.Format("Page_{0}", _pages.Count), typeof(RectTransform),
        ...
        /// <summary>
        /// Called by the PageScroller component when a page change ends.
        /// Sets the page at the fromIndex to inactive and the page at the toIndex to active.
        /// Updates the PageDotsIndicator and invokes the OnPageChanged event.
        /// </summary>
        /// <param name="fromIndex">The index of the page that is being deactivated.</param>
        /// <param name="toIndex">The index of the page that is being activated.</param>
        private void PageScroller_PageChangeEnded(int fromIndex, int toIndex)
        {
            ...
            NotifyOnPageChanged(toIndex);
        }

        private void NotifyOnPageChanged(int toIndex)
        {
            this.Publish(new Notification<int>(nameof(OnPageChanged), toIndex));
        ...
        private PageScroller FindScroller()
        {
            ...
            if (scroller == null)
            {
                UnityEngine.Debug.LogError("Missing PageScroller in Children");
            }
#endif
            return scroller;
        }
        ...
        public class PageSliderEditor : Editor
        {
            #region Variables
            ...
            public override void OnInspectorGUI()
            {
                ...
                _contentPrefab =
                    (RectTransform)EditorGUILayout.ObjectField(_contentPrefab, typeof(RectTransform), false);
